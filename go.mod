...
require (
	github.com/eliona-smart-building-assistant/go-eliona v1.8.1
	github.com/eliona-smart-building-assistant/go-eliona-api-client v1.2.3
	github.com/eliona-smart-building-assistant/go-utils v1.0.6
