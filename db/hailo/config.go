...
type Config struct {
	...
	IntervalSec     int32             `boil:"interval_sec" json:"interval_sec" toml:"interval_sec" yaml:"interval_sec"`
	AuthTimeout     int32             `boil:"auth_timeout" json:"auth_timeout" toml:"auth_timeout" yaml:"auth_timeout"`
	RequestTimeout  int32             `boil:"request_timeout" json:"request_timeout" toml:"request_timeout" yaml:"request_timeout"`
	InactiveTimeout null.Int32        `boil:"inactive_timeout" json:"inactive_timeout,omitempty" toml:"inactive_timeout" yaml:"inactive_timeout,omitempty"`
	Active          null.Bool         `boil:"active" json:"active,omitempty" toml:"active" yaml:"active,omitempty"`
	ProjIds         types.StringArray `boil:"proj_ids" json:"proj_ids,omitempty" toml:"proj_ids" yaml:"proj_ids,omitempty"`
...
var ConfigWhere = struct {
	...
	IntervalSec     whereHelperint32
	AuthTimeout     whereHelperint32
	RequestTimeout  whereHelperint32
	InactiveTimeout whereHelpernull_Int32
	Active          whereHelpernull_Bool
	ProjIds         whereHelpertypes_StringArray
}{
	AppID:           whereHelperint64{field: "\"hailo\".\"config\".\"app_id\""},
	Config:          whereHelpertypes_JSON{field: "\"hailo\".\"config\".\"config\""},
	Enable:          whereHelpernull_Bool{field: "\"hailo\".\"config\".\"enable\""},
	Description:     whereHelpernull_String{field: "\"hailo\".\"config\".\"description\""},
	AssetID:         whereHelpernull_Int32{field: "\"hailo\".\"config\".\"asset_id\""},
	IntervalSec:     whereHelperint32{field: "\"hailo\".\"config\".\"interval_sec\""},
	AuthTimeout:     whereHelperint32{field: "\"hailo\".\"config\".\"auth_timeout\""},
	RequestTimeout:  whereHelperint32{field: "\"hailo\".\"config\".\"request_timeout\""},
	InactiveTimeout: whereHelpernull_Int32{field: "\"hailo\".\"config\".\"inactive_timeout\""},
	Active:          whereHelpernull_Bool{field: "\"hailo\".\"config\".\"active\""},
	ProjIds:         whereHelpertypes_StringArray{field: "\"hailo\".\"config\".\"proj_ids\""},
}
...
var (
	configAllColumns            = []string{"app_id", "config", "enable", "description", "asset_id", "interval_sec", "auth_timeout", "request_timeout", "inactive_timeout", "active", "proj_ids"}
	configColumnsWithoutDefault = []string{"config", "interval_sec"}
	configColumnsWithDefault    = []string{"app_id", "enable", "description", "asset_id", "auth_timeout", "request_timeout", "inactive_timeout", "active", "proj_ids"}
	configPrimaryKeyColumns     = []string{"app_id"}
...
func (q configQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Config, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbhailo: failed to execute a one query for config")
	}
...
func (q configQuery) All(ctx context.Context, exec boil.ContextExecutor) (ConfigSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "dbhailo: failed to assign all query results to Config slice")
	}
...
func (q configQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: failed to count config rows")
	}
...
func (q configQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dbhailo: failed to check if config exists")
	}
...
func Configs(mods ...qm.QueryMod) configQuery {
	mods = append(mods, qm.From("\"hailo\".\"config\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"hailo\".\"config\".*"})
	}
...
func FindConfigG(ctx context.Context, appID int64, selectCols ...string) (*Config, error) {
	return FindConfig(ctx, boil.GetContextDB(), appID, selectCols...)
}

// FindConfig retrieves a single record by ID with an executor.
// If selectCols is empty Find will return all columns.
func FindConfig(ctx context.Context, exec boil.ContextExecutor, appID int64, selectCols ...string) (*Config, error) {
	configObj := &Config{}
	...
	query := fmt.Sprintf(
		"select %s from \"hailo\".\"config\" where \"app_id\"=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbhailo: unable to select from config")
	}
...
func (o *Config) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dbhailo: no config provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"hailo\".\"config\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"hailo\".\"config\" %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "dbhailo: unable to insert into config")
	}
...
func (o *Config) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dbhailo: unable to update config, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"hailo\".\"config\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to update config row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: failed to get rows affected by update for config")
	}
...
func (q configQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to update all for config")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to retrieve rows affected for config")
	}
...
func (o ConfigSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if len(cols) == 0 {
		return 0, errors.New("dbhailo: update all requires at least one column argument")
	}
	...
	sql := fmt.Sprintf("UPDATE \"hailo\".\"config\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to update all in config slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to retrieve rows affected all in update all config")
	}
	return rowsAff, nil
}
...
func (o *Config) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("dbhailo: no config provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("dbhailo: unable to upsert config, could not build update column list")
		}
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"hailo\".\"config\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "dbhailo: unable to upsert config")
	}
...
func (o *Config) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dbhailo: no Config provided for delete")
	}
	...
	sql := "DELETE FROM \"hailo\".\"config\" WHERE \"app_id\"=$1"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to delete from config")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: failed to get rows affected by delete for config")
	}
...
func (q configQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("dbhailo: no configQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to delete all from config")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: failed to get rows affected by deleteall for config")
	}
...
func (o ConfigSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"hailo\".\"config\" WHERE " +
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to delete all from config slice")
	}
...
func (o *Config) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbhailo: no Config provided for reload")
	}
...
func (o *Config) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindConfig(ctx, exec, o.AppID)
	if err != nil {
		return err
	}
...
func (o *ConfigSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbhailo: empty ConfigSlice provided for reload all")
	}
...
func (o *ConfigSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"hailo\".\"config\".* FROM \"hailo\".\"config\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, configPrimaryKeyColumns, len(*o))
	...
	if err != nil {
		return errors.Wrap(err, "dbhailo: unable to reload all in ConfigSlice")
	}
...
func ConfigExistsG(ctx context.Context, appID int64) (bool, error) {
	return ConfigExists(ctx, boil.GetContextDB(), appID)
}

// ConfigExists checks if the Config row exists.
func ConfigExists(ctx context.Context, exec boil.ContextExecutor, appID int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"hailo\".\"config\" where \"app_id\"=$1 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dbhailo: unable to check if config exists")
	}
