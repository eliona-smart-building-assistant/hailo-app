...
var AssetWhere = struct {
	...
	ConfigID: whereHelperint64{field: "\"hailo\".\"asset\".\"config_id\""},
	DeviceID: whereHelperstring{field: "\"hailo\".\"asset\".\"device_id\""},
	ProjID:   whereHelperstring{field: "\"hailo\".\"asset\".\"proj_id\""},
	AssetID:  whereHelperint32{field: "\"hailo\".\"asset\".\"asset_id\""},
}
...
var (
	assetAllColumns            = []string{"config_id", "device_id", "proj_id", "asset_id"}
	assetColumnsWithoutDefault = []string{"config_id", "device_id", "proj_id", "asset_id"}
	assetColumnsWithDefault    = []string{}
	assetPrimaryKeyColumns     = []string{"config_id", "device_id", "proj_id", "asset_id"}
...
func (q assetQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Asset, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbhailo: failed to execute a one query for asset")
	}
...
func (q assetQuery) All(ctx context.Context, exec boil.ContextExecutor) (AssetSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "dbhailo: failed to assign all query results to Asset slice")
	}
...
func (q assetQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: failed to count asset rows")
	}
...
func (q assetQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dbhailo: failed to check if asset exists")
	}
...
func Assets(mods ...qm.QueryMod) assetQuery {
	mods = append(mods, qm.From("\"hailo\".\"asset\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"hailo\".\"asset\".*"})
	}
...
func FindAssetG(ctx context.Context, configID int64, deviceID string, projID string, assetID int32, selectCols ...string) (*Asset, error) {
	return FindAsset(ctx, boil.GetContextDB(), configID, deviceID, projID, assetID, selectCols...)
}

// FindAsset retrieves a single record by ID with an executor.
// If selectCols is empty Find will return all columns.
func FindAsset(ctx context.Context, exec boil.ContextExecutor, configID int64, deviceID string, projID string, assetID int32, selectCols ...string) (*Asset, error) {
	assetObj := &Asset{}
	...
	query := fmt.Sprintf(
		"select %s from \"hailo\".\"asset\" where \"config_id\"=$1 AND \"device_id\"=$2 AND \"proj_id\"=$3 AND \"asset_id\"=$4", sel,
	)

	q := queries.Raw(query, configID, deviceID, projID, assetID)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbhailo: unable to select from asset")
	}
...
func (o *Asset) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dbhailo: no asset provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"hailo\".\"asset\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"hailo\".\"asset\" %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "dbhailo: unable to insert into asset")
	}
...
func (o *Asset) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dbhailo: unable to update asset, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"hailo\".\"asset\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to update asset row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: failed to get rows affected by update for asset")
	}
...
func (q assetQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to update all for asset")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to retrieve rows affected for asset")
	}
...
func (o AssetSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"hailo\".\"asset\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to update all in asset slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to retrieve rows affected all in update all asset")
	}
	return rowsAff, nil
}
...
func (o *Asset) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("dbhailo: no asset provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("dbhailo: unable to upsert asset, could not build update column list")
		}
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"hailo\".\"asset\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "dbhailo: unable to upsert asset")
	}
...
func (o *Asset) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dbhailo: no Asset provided for delete")
	}
	...
	sql := "DELETE FROM \"hailo\".\"asset\" WHERE \"config_id\"=$1 AND \"device_id\"=$2 AND \"proj_id\"=$3 AND \"asset_id\"=$4"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to delete from asset")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: failed to get rows affected by delete for asset")
	}
...
func (q assetQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("dbhailo: no assetQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to delete all from asset")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: failed to get rows affected by deleteall for asset")
	}
...
func (o AssetSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"hailo\".\"asset\" WHERE " +
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbhailo: unable to delete all from asset slice")
	}
...
func (o *Asset) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbhailo: no Asset provided for reload")
	}
...
func (o *Asset) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindAsset(ctx, exec, o.ConfigID, o.DeviceID, o.ProjID, o.AssetID)
	if err != nil {
		return err
	}
...
func (o *AssetSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbhailo: empty AssetSlice provided for reload all")
	}
...
func (o *AssetSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"hailo\".\"asset\".* FROM \"hailo\".\"asset\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, assetPrimaryKeyColumns, len(*o))
	...
	if err != nil {
		return errors.Wrap(err, "dbhailo: unable to reload all in AssetSlice")
	}
...
func AssetExistsG(ctx context.Context, configID int64, deviceID string, projID string, assetID int32) (bool, error) {
	return AssetExists(ctx, boil.GetContextDB(), configID, deviceID, projID, assetID)
}

// AssetExists checks if the Asset row exists.
func AssetExists(ctx context.Context, exec boil.ContextExecutor, configID int64, deviceID string, projID string, assetID int32) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"hailo\".\"asset\" where \"config_id\"=$1 AND \"device_id\"=$2 AND \"proj_id\"=$3 AND \"asset_id\"=$4 limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, configID, deviceID, projID, assetID)
	}
	row := exec.QueryRowContext(ctx, sql, configID, deviceID, projID, assetID)

	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dbhailo: unable to check if asset exists")
	}
